      ...
      <div id="resources" className="home-hero">
        <div className="home-content-container">
          <div className="home-hero-text">
            <h1 className="home-heading section-Heading">YFX Studios</h1>
            <button className="home-cta-btn1 anchor button">Subscribe</button>
            <span className="home-text section-Text">
              Watch our newest video!
            </span>
            <iframe
              src="https://www.youtube.com/embed/watch?v=52d1TXDCpYI&amp;list=PLcdXr5OXLMsFPPjIQQY-iDhlMXlv0p8mz&amp;index=1/"
              allowFullScreen
        ...
        <div className="home-cards-container">
          <div className="home-features-card">
            ...
            <div className="home-text-container">
              <span className="home-heading01 card-Heading">
                Animation Tutorials
              </span>
              <span className="home-text02 card-Text">
                We use Blender and After Effects to animate characters and other
                objects. We enjoy sharing tips and tricks that we find.
              </span>
            </div>
          </div>
          <div className="home-features-card1">
            ...
            <div className="home-text-container1">
              <span className="home-heading02 card-Heading">
                Technology Projects &amp; Tutorials
              </span>
              <span className="home-text03 card-Text">
                We create projects using Arduino, Raspberry Pi, and many more.
                We solve problems with sometimes simple solutions. We love to
                share our knowledge and learn from our community.
              </span>
            </div>
          </div>
          <div className="home-features-card2">
            ...
            <div className="home-text-container2">
              <span className="home-heading03 card-Heading">Piano</span>
              <span className="home-text04 card-Text">
                We love to play piano and share our songs with others. Our
                videos can help you know what the song sounds like, and how to
                play it.
              </span>
            </div>
          </div>
          <div className="home-features-card3">
            ...
            <div className="home-text-container3">
              <span className="home-heading04 card-Heading">
                Coming Soon: Networking/IT
              </span>
              <span className="home-text05 card-Text">
                We use Ubuntu Linux to analyze weaknesses in websites and fix
                them. We also teach how to hack websites.
              </span>
            </div>
          </div>
      ...
      <div id="process" className="home-services">
        ...
        <div className="home-cards-container1">
          <div className="home-service-card">
            <h3 className="home-text10 card-Heading">
              YouTube Channels We Recommend
            </h3>
            <span className="home-text11 card-Text">
              You are not restricted on using just our YouTube channel to find
              information, Use others! We have created a list of YouTubers that
              have knowledge about subjects that we are talking about.
            </span>
          ...
          <div className="home-service-card2">
            <h3 className="home-text14">Video Comments</h3>
            <span className="home-text15 card-Text">
              Ask Questions in the comments! We try our best to reply as quickly
              as we can.
            </span>
            <a
              href="https://support.google.com/youtube/answer/6000964"
              target="_blank"
              rel="noreferrer noopener"
              className="home-link10 anchor"
            >
              Learn more
            </a>
          </div>
